...
class CurrentDayDateRowState extends State<CurrentDayDateRow> {
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero, () {
      pageController.animateToPage(
        weekIndex,
        duration: const Duration(milliseconds: 800), // ระยะเวลาในการเลื่อน
  ...
  List<DateTime> _generateMultiMonthDates(DateTime baseDate,
      {int monthsBefore = 2, int monthsAfter = 2}) {
  ...
  int calculateWeekIndex(
      List<DateTime> multiMonthList, DateTime currentDateTime) {
